...
- **Insecure Key Properties**: Generating keys with properties such as an unspecified or overly broad purpose, insecure storage location (e.g. not using secure hardware if available) or access requirements (see @MASWE-0010).
